...
SERVER_URL = "http://futrax.fr:8000"
if os.environ.get('DJANGO_DEVELOPMENT'):
    SERVER_URL = "http://127.0.0.1:8000"
API_URL = "http://{}".format(SERVER_URL)
WS_URL = "ws://{}/ws/live/debug/".format(SERVER_URL)
...
def get_company_data(company):
    ...
    response = httpx.post(URL_REF + company.ref, data=js, timeout=None)
